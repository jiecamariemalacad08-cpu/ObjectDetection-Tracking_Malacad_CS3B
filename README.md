...
├── saved_frames/        # Automatically saved images
...
1. The system accesses your webcam using WebRTC.
2. Each video frame is processed using YOLOv8.
3. Detected objects are:
   - Labeled and tracked
   - Counted in real-time
4. If objects are detected:
   - The frame is automatically saved every few seconds
5. Alerts are triggered for specific objects (e.g., "person")
